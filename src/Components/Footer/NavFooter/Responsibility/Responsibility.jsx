    ...
    <div>
      <div className="cnt">
        ...
        <p>
          ...
          responsible for their actions or omissions and our interest with each
          of our clients is exclusively professional. <br />
          We are independent entities and in no way connected to any of our
          clients. We do not get paid with tokens from projects or other means
          of direct ownership or influence in a specific project unless we
          publicly announce it. <br />
          All information on the website, platforms and all the work we provide
          to our clients and all communities is provided in good faith. However,
          ...
          make do their own research in and for every crypto project you have
          any interest in.
        </p>
      </div>
      <Footer />
