...
function Privacy() {
  return (
    <div>
      <div className="cnt">
        <h1>COOKIES AND POLICIES</h1>
        <h2>Disclaimer</h2>
        <p>
          If you require any more information or have any questions about our
          site’s disclaimer, please feel free to contact us by email at
          info@phoenixstrategy.com <br />
          This is the disclaimer for www.phoenixstrategy.com <br />
          All the information on this website is published in good faith and for
          general information purpose only. www.phoenixstrategy.com does not
          ...
          on this website (www.phoenixstrategy.com), is strictly at your own
          risk. www.phoenixstrategy.com will not be liable for any losses and/or
        ...
        <h2>Update</h2>
        <p>
          This site disclaimer was last updated on April 24th 2020. Should we
          update, amend or make any changes to this document, those changes will
        ...
        <ol>
          <li>
            The personally identifiable information that is collected from you
            through the web site. How this information is used and with whom it
            may be shared.
          </li>
          <li>
        ...
        <p>
          ...
          your request, e.g. to answer your queries.
          <br />
        ...
        <p>
          ...
          generated relating to our website is used to create reports about the
          use of the website. Google will store and use this information.
        ...
        <ul>
          <li> See what data we have about you, if any at all.</li>
          <li>Change/correct any data we have about you.</li>
          <li>
            Have us to delete any data we have about you that is not required by
            law for us to maintain.
          </li>
